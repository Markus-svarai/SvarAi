  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div className="rounded-2xl border border-ink-100 bg-white shadow-card overflow-hidden">
        ...
        {/* Messages */}
        <div
          className="h-80 overflow-hidden px-4 py-4 relative"
        ...
        >
          ...
          <div style={{
            ...
            animation: "waveScrollB 7s linear infinite",
            pointerEvents: "none",
            filter: "blur(0.4px)",
          }} />
          {/* Front layer – messages */}
          <div className="relative space-y-3" style={{ transform: "translateZ(0px)", zIndex: 1 }}>
