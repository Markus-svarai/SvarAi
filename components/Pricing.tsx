const plans = [
  ...
  },
  {
    ...
    price: 2990,
    badge: "Kommer snart",
    description: "For klinikker som vil ha AI både på nett og telefon.",
    features: [
      "Alt i Starter",
      "AI-telefonsvarer – svarer anrop automatisk",
      "SMS-bekreftelse til pasienter",
      "Avbestilling og ombooking",
      "Ubegrenset samtaler",
      "Prioritert support",
    ],
    cta: "Varsle meg når det er klart",
    ctaHref: "#kontakt",
    highlight: false,
    comingSoon: true,
  },
  {
    ...
    price: null,
    badge: "Kommer snart",
    description: "Skreddersydd løsning for klinikker med flere avdelinger eller spesielle behov.",
    features: [
      "Alt i Pro",
      "Flere avdelinger og lokasjoner",
      "Tilpasset AI-opplæring",
      "Dedikert kontaktperson",
      "SLA-garanti og prioritert drift",
      "Tilpasset pris",
    ],
    cta: "Ta kontakt",
    ctaHref: "#kontakt",
